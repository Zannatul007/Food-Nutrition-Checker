...
def predict():
    if request.method == 'POST':
        ...
        if image:
            ...
            encoding_16_224 = feature_extractor_16_224(img, return_tensors="pt")
            encoding_16_384 = feature_extractor_16_384(img, return_tensors="pt")
            ...
            # # Define processes
            # p1 = multiprocessing.Process(target=probabilities_finder, args=("p1", m1, encoding_16_384, vitB_16_384_1e_4_adam_prob_list))
            # p2 = multiprocessing.Process(target=probabilities_finder, args=("p2", m2, encoding_16_384, vitB_16_384_2e_4_adam_prob_list))
            # p3 = multiprocessing.Process(target=probabilities_finder, args=("p3", m3, encoding_16_384, vitB_16_384_1e_4_rms_prob_list))
            # p4 = multiprocessing.Process(target=probabilities_finder, args=("p4", m4, encoding_16_384, vitB_16_384_2e_4_rms_prob_list))
            # p5 = multiprocessing.Process(target=probabilities_finder, args=("p5", m5, encoding_16_224, vitB_16_224_1e_4_adam_prob_list))
            # p6 = multiprocessing.Process(target=probabilities_finder, args=("p6", m6, encoding_16_224, vitB_16_224_2e_4_adam_prob_list))
            # p7 = multiprocessing.Process(target=probabilities_finder, args=("p7", m7, encoding_16_224, vitB_16_224_1e_4_rms_prob_list))
            # p8 = multiprocessing.Process(target=probabilities_finder, args=("p8", m8, encoding_16_224, vitB_16_224_2e_4_rms_prob_list))
            # Start processes
            # print("process Start")
            # p1.start()
            # p2.start()
            ...
            vitB_16_224_prob_arr = np.stack([prob.numpy() for prob in vitB_16_224_prob])
            vitB_16_384_prob_arr = np.stack([prob.numpy() for prob in vitB_16_384_prob])
            vitB_32_224_prob_arr= np.stack([prob.numpy() for prob in vitB_32_224_prob])
            vitB_32_384_prob_arr= np.stack([prob.numpy() for prob in vitB_32_384_prob])
...
if __name__ == '__main__':
    m1 = AutoModelForImageClassification.from_pretrained("ZaneHorrible/adam_VitB-p16-224-1e-4-batch_16_epoch_4_classes_24")
    m2 =AutoModelForImageClassification.from_pretrained("ZaneHorrible/google-vit-base-patch16-384-batch_16_epoch_4_classes_24")
    m3 = AutoModelForImageClassification.from_pretrained("ZaneHorrible/adam_ViTB-32-224-in21k-2e-4-batch_16_epoch_4_classes_24")
    m4 = AutoModelForImageClassification.from_pretrained("ZaneHorrible/rmsProps_VitB-p32-384-1e-4-batch_32_epoch_4_classes_24")

    print("Model loaded")
    feature_extractor_16_224 = AutoFeatureExtractor.from_pretrained("ZaneHorrible/rmsprop_VitB-p16-224-1e-4-batch_16_epoch_4_classes_24")
    feature_extractor_16_384 = AutoFeatureExtractor.from_pretrained("ZaneHorrible/rmsProp_VitB-p16-384-2e-4-batch_16_epoch_4_classes_24")
